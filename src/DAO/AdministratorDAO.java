...
public class AdministratorDAO {
	...
	public boolean create(Administrator a) throws ClassNotFoundException, SQLException {
        ...
        try {
            ...
            //MÈtodo de verificaÁ„o do CPF, sÛ pode ter n˙meros
            ...
            System.out.println("Entrou aqui no SQLException: " + ex.getMessage());
            return false;
        } finally {
            System.out.println("Finalizou a conex„o");
    ...
    // chave primaria/ pesquisa È o cpf
        ...
        try {
            ...
            if (rs.next()) {
               ...
               admin.setLogin(ls);
                ...
                throw new RuntimeException("A pesquisa n„o retronou nenhum resultado!");
            }
            return admin;
        } catch (SQLException ex) {
